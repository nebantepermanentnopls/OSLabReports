...
**LVM**(logical volume manager) - технология распределения пространства диска на логические тома, размер которых можно изменять во время работы(без удаления, как в случае с разделами).
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image16.jpg)

2) После перезагрузки система работает, узнаем о состоянии RAID-массива.

Через mdstat и fdisk:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image17.jpg)

lsblk:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image18.jpg)

Удаленный диск пропал, в массиве присутствует только 1 диск.

4) После добавления нового ssd4 утилиты выводят следующее:
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image19.jpg)

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image20.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image21.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image22.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image25.jpg)
...
Разберем ключи приведенной команды:
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image27.jpg)

* Также посмотрим состояние дисков утилитой lsblk:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image28.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image29.jpg)

6) Настраиваем LVM

* Утилита pvs показывает, что в данный момент у нас только один физический том:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image30.jpg)

* Создадим новый, который будет содержать новый массив: ```pvcreate /dev/md127```.

* Посмотрим результат:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image31.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image32.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image35.jpg)
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image36.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image37.jpg)
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image38.jpg)
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image39.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image40.jpg)
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image41.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image43.jpg)

На sda нет точек монтирования.

* Выполним команду ```ls /boot```:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image44.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image45.jpg)

8) Утилиты fdisk и lsblk показали, что появились новые доступные для работы диски.

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image46.jpg)

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image47.jpg)

9) Копируем разделы с ssd4 на ssd5 командой ```sfdisk -d /dev/sda | sfdisk /dev/sdb```. Получаем результат:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image49.jpg)
...
12) Используем команду ```fdisk /dev/sdb```, с помощью который:
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image50.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image51.jpg)

14) Аналогично пункту 12 увеличиваем размер раздела на ssd4.

15) Перечитываем таблицу разделов: ```partx -u /dev/sda``` и получаем:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image52.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image53.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image54.jpg)

Получили 2g свободного места.

18) Разделяем свободное пространств между томами root и var:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image55.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image56.jpg)

* Создаем новый RAID-массив из этих дисков и организуем работу LVM(утилиты pvcreate, vgcreate и lvcreate) :

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image57.jpg)

* Создаем том с размером всего массива и оформляем новый раздел в etx4:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image58.jpg)

* Результат наших действий:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image59.jpg)

20) Перенос логов со старого раздела на новый:

* Монтируем временное хранилище логов: 

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image61.jpg)

* С помощью утилиты rsync синхронизируем разделы: 

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image62.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image63.jpg)

* Выполняем финальную синхронизацию:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image64.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image65.jpg)

21) Изменяем файл в котором записываются правила, по которым при загрузке будут смонтированы разделы - /etc/fstab:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image66.jpg)

Меняем предпоследнюю строчку:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image67.jpg)

22) Используем команду resize2fs для уведомления ФС о изменении размеров разделов:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image69.jpg)

23) Финальный результат наших действий:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image70.jpg)

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image71.jpg)

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image72.jpg)
...
![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image73.jpg)

Не забываем уведомить ФС о новых размерах:

![](https://github.com/nebantepermanentnopls/OSLabReports/blob/master/lab2/images/image74.jpg)

**Вывод**:В ходе выполнения данного задания были получены знания об изменении размера разделов и логических томов, переносе разделов, создании новых RAID-массивов.
